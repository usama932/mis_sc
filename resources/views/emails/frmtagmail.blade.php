...
<div class="container">
    ...
    <div class="email-content">
        <p>Dear Concerned,</p>
        <p>Following are the FRM details for {{$details['feedback_activity']}} in {{$details['village']}} received on {{$details['date_received']}} is tag By <strong>{{ $details['tag_by'] }}</strong> for your consideration. 
        ...
        <table>
            <thead>
                <tr>
                    <th colspan="4">FRM Response ID: {{$details['response_id']}}</th>
                </tr>
                <tr>
                    <th>Feedback Description</th>
                    <th>Feedback Tag</th>
                    <th>Feedback Tag By</th>
                    <th>View Detail</th>
                </tr>
            </thead>
            <tbody>
