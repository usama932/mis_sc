                        ...
                        <form class="edit_quarter_status_form" method="post" autocomplete="off" action="{{ route('quarterstatus.edit',$month->id) }}">   
                            ...
                            <div class="row">
                                <div class="fv-row col-md-2">
                                    ...
                                    <input type="text" name="quarter" value="{{$month->activity?->slug?->slug}}-{{$month->activity?->year}}" id="lop_target" class="form-control form-control-solid" readonly>
                                </div> 
                                <div class="fv-row col-md-2 ">
                                    <label class="fs-7 fw-semibold form-label mb-2 d-flex">
                                        <span class="required">Quarterly Target</span>
                                    </label>
                                    <input type="text" name="lop_target" id="lop_target" value="{{$month->activity?->activity?->lop_target ?? '0'}}" class="form-control form-control-solid" readonly>
