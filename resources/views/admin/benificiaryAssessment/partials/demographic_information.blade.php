<div class="card-body">
    <div class="row">
        <div class="fv-row col-md-6">
            ...
            <select name="project" id="projectId" class="form-control form-select" data-control="select2" data-placeholder="Select Project" data-allow-clear="true" required>
                <option value="">Select Project</option>
                @foreach ($projects as $project)
                    <option value="{{ $project->id }}">{{ $project->name }}</option>
                @endforeach
            </select>
            <div id="projectError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        
        <div class="fv-row col-md-6">
            <label class="fs-6 fw-bolder required">Date</label>
            <input type="text" name="date" id="mpca_Date" class="form-control" required/>
            <div id="dateError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-3 mt-5">
            ...
            <div id="provinceError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-3  mt-3">
            ...
            <div id="districtError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-3  mt-3">
            ...
            <div id="tehsilError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-3  mt-3">
            ...
            <div id="ucError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-6">
            ...
            <div id="villageError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
        ...
        <div class="fv-row col-md-6">
            ...
            <div id="subvillageError" class="invalid-feedback"></div> <!-- Positioning here is correct -->
        </div>
    </div>
</div>
