<div class="card-body">
    <div class="row">
        <div class="fv-row col-md-6">
            <label class="fs-6 fw-bolder form-label required">Project</label>
            ...
            <div id="projectError" class="invalid-feedback"></div>
        </div>
        <div class="fv-row col-md-6">
            <label class="fs-6 fw-bolder form-label required">Date</label>
            <input type="text" name="date" id="mpca_Date" class="form-control" required/>
            <div id="dateError" class="invalid-feedback"></div>
        </div>
        <div class="fv-row col-md-3">
            <label class="fs-6 fw-bolder form-label required">Province</label>
