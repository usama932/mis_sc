                ...
                <div class="card-body py-4">
                    <div class="row">
                        <div class="fv-row col-md-4">
                            ...
                            <select name="indicatorId" id="indicatorId" class="form-select  " data-control="select2" data-placeholder="Select Indicators"  data-allow-clear="true">
                        ...
                        <div class="fv-row col-md-7">
                            ...
                            <select name="activities[]" multiple id="activities" class="form-select  " data-control="select2" data-placeholder="Select Activities"  data-allow-clear="true">
