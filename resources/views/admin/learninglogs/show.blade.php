...
<x-nform-layout>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div class="d-flex justify-content-between m-2">
            <a href="{{route('learning-logs.index')}}" class="btn btn-primary btn-sm" title="Return to Explore"><i class="fa fa-arrow-left " aria-hidden="true"></i></a>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4 ">
                            <div class="mt-5">
                                ...
                                </svg><!--end::Svg Icon--></span> {{$log->projects->name ?? ''}} ({{$log->project_type ?? ''}})
                            </div>
                            <div class="mt-5">
                                <h6>District</h6>
                    ...
                    <div class="row"> 
                        <div class="col-md-4 ">
                            <div class="mt-5">
                                ...
                                </svg><!--end::Svg Icon--></span> {{ $log->created_at->format('M d,Y H:i:s')}}
                            </div>
                        </div>
                        <div class="col-md-4 ">
                            <div class="mt-5">
