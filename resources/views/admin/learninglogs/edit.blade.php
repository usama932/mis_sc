<x-nform-layout>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div class="card">
            <form action="{{route('learning-logs.update',$log->id)}}" data-kt-redirect-url="{{ route('learning-logs.index') }}" method="post" id="learninglog" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
