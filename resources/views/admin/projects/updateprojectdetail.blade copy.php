            ...
            <form action="{{route('project.update')}}" method="post" id="create_dip" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body py-4">
                    <div class="row">
                        ...
                        <div class="separator separator-dotted separator-content border-dark my-15"><span class="h5">Destination</span></div>
                        ...
                        <div class="fv-row col-md-4 ">
                            ...
                            <input type="text" name="pwd_targets" id="pwd_targets"  placeholder="Enter PWD Targets" class="form-control" value="0">
                            <div id="pwd_targetsError" class="error-message "></div>
                        </div>
                        <div class="fv-row col-md-3 ">
                            <label class="fs-6 fw-semibold form-label mb-2 d-flex">
