        ...
        <div class="px-5">
            ...
            <div class="row ">
                ...
                <div class="fv-row col-md-4 mt-4">
                    <select   name="province"  id="kt_province" aria-label="Select a Province" data-control="select2" data-placeholder="Select Partner Province" class="form-select "  data-allow-clear="true" >
                ...
                <div class="fv-row col-md-4 mt-4">
                    ...
                    <select id="kt_district" name="district" aria-label="Select a district" data-control="select2" data-placeholder="Select Partner District" class="form-select "  data-allow-clear="true">    
                    </select>
                </div>
                <div class="fv-row col-md-4 mt-4">
