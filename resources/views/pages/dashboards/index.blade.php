<x-default-layout>
    ...
    @endsection
    <style>
        /* Set a fixed height for the table body and enable vertical scrolling */
        .table-scrollable {
            display: block;
        ...
        .table-scrollable thead th, .table-scrollable tbody td {
            width: 200px; /* Adjust this value based on your column width */
        }
    </style>
    @can('dashboards')
        {{-- <!--begin::Row-->
                                ...
                                <div class="card h-md-100 ">
                                    ...
                                    <div class="card-header border-0 ">
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bold text-dark">Project Activites Count</span>
                                        </h3>
                                    </div>
                                                ...
                                                <tbody>
                                                    @foreach ($project_data as $project)
                                                        <tr>
                                                            ...
                                                            <td>{{ $project->total_activities_count }}</td>
                                                            <td>{{ $project->complete_activities_count }}</td>
                                                            <td>{{ $project->overdue_count }}</td>
                                                            <td>{{ $project->pending_count }}</td>
                                                        </tr>
                                                    @endforeach
